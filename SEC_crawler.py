...
##				print(souptext)
			...
			if lct==-1:
				if souptextlower.find("no public market for the registrantâ€s common stock")>0:
				...
				elif souptextlower.find("no established public trading market for registrantâ€s units")>0:
				...
				if pos-lct>700 or pos==-1:
					if souptextlower.find("no public market for the registrantâ€s common stock", lct-200, lct+400)>0:
						mktval = "no public market"
					elif souptextlower.find("no definition available", lct-200, lct+400)>0:
						mktval = "no definition available"
						...
						mktval = "no voting common equity"
					elif souptextlower.find("no established public trading market for registrantâ€s units", lct-200, lct+400)>0:
						mktval = "no public trading market"
...
##				print(row[2])
	...
	if mode==1:
##		print(filertyper)
		if "x" in filertyper[1][1] or "Ãƒ" in filertyper[1][1] or "Ã¾" in filertyper[1][1] or "Ã½" in filertyper[1][1] or "Ã¼" in filertyper[1][1]:
			file = "accelerated filer"
			return file
		if "x" in filertyper[0][1] or "Ãƒ" in filertyper[0][1] or "Ã¾" in filertyper[0][1] or "Ã½" in filertyper[0][1] or "Ã¼" in filertyper[0][1]:
